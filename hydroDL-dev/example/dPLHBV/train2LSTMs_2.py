...
statDict_wghts = camels.getStatDic(attrLst=attrWghts, attrdata=attrs_wghtsUN, seriesLst=['prcp_daymet', 'prcp_maurer', 'prcp_nldas',
                                                                                         'tmax_daymet', 'tmax_maurer', 'tmax_nldas',
                                                                                         'pet_daymet', 'pet_maurer', 'pet_nldas'], seriesdata=series_inv)
# normalize data
...
series_Wghts_norm = camels.transNormbyDic(series_inv, ['prcp_daymet', 'prcp_maurer', 'prcp_nldas',
                                                       'tmax_daymet', 'tmax_maurer', 'tmax_nldas',
...
exp_name = 'CAMELSDemo'
if forType==['daymet', 'maurer_extended', 'nldas_extended']:
    exp_disp = 'LSTM-dPLHBV/' + puN + TDN + 'allprcp_7withloss' + str(prcp_loss_factor) + 'smooth' + str(smooth_loss_factor) + '/BuffOpt'+str(buffOpt)+'/RMSE_para'+str(alpha)+'/' + str(randomseed) + \
