...
buffOptOri = 0  # original buffOpt, Same as what you set for training3
...
prcp_loss_factor = 200 #used only when multiforcing is True; else does not matter
...
# Ttrain = [19801001, 19821001]  # Training period
...
# Ttest = [19831001, 19951001]  # testing period
...
# TtestLoad = [19831001, 19951001]  # could potentially use this to load more forcings before testing period as warm-up
...
if forType == ['daymet', 'maurer_extended', 'nldas_extended']:
    testsave_path = 'CAMELSDemo/dPLHBV/' + puN + '/TDTestforc/' + 'TD' + "_".join(tdRepS) + '/allForcsModified_withloss'+str(prcp_loss_factor)+'smooth'+str(smooth_loss_factor)+'/BuffOpt' + str(buffOptOri) + '/RMSE_para'+ str(alpha) + '/' + str(testseed)
