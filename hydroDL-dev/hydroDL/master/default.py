...
from hydroDL.data import dbCsv, camels, gages
...
optLossNSE = OrderedDict(name='hydroDL.model.crit.NSELossBatch', prior='gauss')
...
optLossRMSERunoff = OrderedDict(name='hydroDL.model.crit.RmseLossRunoff', prior='gauss')
optLossComb = OrderedDict(name='hydroDL.model.crit.RmseLossComb', prior='gauss', weight=0.0)
